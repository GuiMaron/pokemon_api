...
const MONGODB_USER = process.env.MONGO_INITDB_ROOT_USERNAME;
const MONGODB_PASS = process.env.MONGO_INITDB_ROOT_PASSWORD;
const MONGODB_DATABASE = `${process.env.MONGO_DB_DATABASE}`;
const MONGODB_COLLECTION = `${process.env.MONGO_DB_COLLECTION}`;
...
console.debug(`\n\n --- CLEARING THE COLLECTION: ${MONGODB_COLLECTION}`);
collection.drop();

// Inserting the data
console.debug(`\n\n --- FILLING THE COLLECTION: ${MONGODB_COLLECTION}`);
(async() => {
